...
/*
    Exercicio Pratico 4 Curso de C# 

    Quebrando a frase em pedaços e armazenando em um array os dados do programa console


Console.Write("Digite Qualquer coisa: ");

string[] qualquercoisa = Console.ReadLine().Split(' ');
string teste = qualquercoisa[0];
string teste1 = qualquercoisa[1];
string teste2 = qualquercoisa[2];
string teste3 = qualquercoisa[3];
